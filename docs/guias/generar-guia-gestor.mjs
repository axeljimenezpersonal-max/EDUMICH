 ...
 * Chromium, que se imprimía en TODAS —incluida la portada, donde repetía
 * "Guía del gestor" con el título a tres centímetros—. Dibujarlo aquí permite
 * que la portada tenga el suyo y el resto el corrido.
 *
 ...
 * vez de interrumpirla. Antes llevaba una etiqueta "OJO" en guinda y una barra
 * gruesa, que competía con el contenido y hacía ver de alarma algo que casi
 * siempre es una aclaración.
 */
...
const CAP8 = pagina(`
  ...
  <div class="tarjetas">
    ...
    ${tarjeta('Ten a la mano', `Tu municipio y la CURP del alumno del que hablas: agilizan
      cualquier revisión.`)}
    ${tarjetaAncha('Soporte de la plataforma', `Si el sistema falla o no puedes entrar, escribe a
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; }
  ...
  .portada-frase { margin-top: 12mm; font-size: 13pt; line-height: 1.7; max-width: 118mm;
                   padding-bottom: 7mm; border-bottom: 0.3mm solid rgba(255,255,255,0.22); }
  .portada-frase span { color: ${C.doradoSuave}; font-weight: 600; }
  /* Una sola línea: la firma institucional a la izquierda y la paginación a la
     derecha. Antes eran DOS líneas —ésta y el pie corrido de Chromium, que
     repetía "Guía del gestor" cuando el título ya está tres centímetros
     arriba—. Por eso el pie ahora se dibuja dentro de cada página. */
