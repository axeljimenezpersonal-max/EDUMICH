...
import {
  ...
  MessageCircle, ClipboardList, BookOpen, Video, ChevronDown, Lock,
} from 'lucide-react';
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-[220px_1fr] gap-6 w-full">
        ...
        <nav className="md:sticky md:top-[114px] self-start">
          <div className="bg-white border border-stone-200 rounded-md overflow-hidden">
            ...
            {/* Mi aula — botón desplegable. Si no está contratada, en gris con
                candado (clic → pantalla para adquirir el beneficio). */}
            <div className="border-t border-stone-100">
              {aula ? (
                ...
                <Link href="/gestor/aula" data-tour="nav-aula"
                  ...
                  style={{ color: '#a8a29e' }}
                  title="Aula Virtual no activada — contacta a la Secretaría">
                  <School size={16} />
                  <span className="flex-1 text-left font-semibold">Mi aula</span>
                  <Lock size={13} />
                </Link>
