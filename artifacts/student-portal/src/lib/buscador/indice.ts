...
const SECCIONES_ALUMNO: EntradaIndice[] = [
  ...
  },
  {
    ...
    cuerpo: 'Las dudas más comunes ya resueltas: inscripción, pago, documentos, examen.',
    ruta: '/estudiante/faq',
    icono: 'HelpCircle',
    roles: [...ALUMNO],
    terminos: [
      'preguntas', 'frecuentes', 'faq', 'ayuda', 'dudas', 'duda', 'soporte',
      'contacto', 'como', 'no se', 'no entiendo',
    ],
  },
  {
    id: 'sec-alu-avisos',
...
const SECCIONES_GESTOR: EntradaIndice[] = [
  ...
  },
  {
    ...
    tipo: 'seccion',
    titulo: 'Preguntas frecuentes',
    cuerpo: 'Las dudas más comunes ya resueltas.',
    ruta: '/gestor/faq',
    icono: 'HelpCircle',
    roles: [...GESTOR],
    terminos: ['preguntas', 'frecuentes', 'faq', 'ayuda', 'dudas', 'contacto', 'soporte'],
  },
];
...
const SECCIONES_ADMIN: EntradaIndice[] = [
  ...
  },
  {
    ...
    tipo: 'seccion',
    titulo: 'Sedes',
    cuerpo: 'Lugares donde se presentan los exámenes. Viven dentro de Convocatorias.',
    ruta: '/admin/convocatorias?vista=sedes',
    icono: 'MapPin',
    roles: [...ADMIN],
