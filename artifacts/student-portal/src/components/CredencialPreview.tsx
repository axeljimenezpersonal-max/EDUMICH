/**
 * Credencial digital — tarjeta GRANDE volteable (frente + reverso), idéntica en
 * estilo a la que ve el alumno. Reutilizable por admin y gestor: recibe
 * `basePath` (p. ej. /admin/alumnos/25 o /gestor/alumnos/25) y consulta
 * `${basePath}/credencial`. SIEMPRE refleja la credencial realmente emitida
 * (mismos datos, mismo folio, misma foto aprobada).
 */
...
// Paleta (misma que la credencial del alumno)
const G = {
...
export function CredencialPreview({ basePath }: { basePath: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      >
        <div style={{ position: 'relative', width: '100%', height: '100%', transformStyle: 'preserve-3d', transition: 'transform .55s cubic-bezier(.4,.2,.2,1)', transform: flipped ? 'rotateY(180deg)' : 'rotateY(0deg)' }}>
