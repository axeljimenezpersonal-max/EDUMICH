      ...
      <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #e2d9d0;max-width:580px;">
        ...
        <tr><td style="padding:0 32px 24px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#fdf8f9;border:2px solid #7b1e3a;border-radius:8px;overflow:hidden;">
            <tr><td style="background:#7b1e3a;padding:10px 18px;"><span style="color:#fff;font-size:11px;font-weight:bold;letter-spacing:2px;text-transform:uppercase;">Tus credenciales de acceso</span></td></tr>
        ...
        <tr><td style="padding:0 32px 28px 32px;" align="center">
          <a href="${data.portalUrl}" style="display:inline-block;background:#7b1e3a;color:#ffffff;text-decoration:none;font-size:15px;font-weight:bold;padding:16px 40px;border-radius:8px;letter-spacing:1px;text-transform:uppercase;">ACCEDER AL PANEL</a>
        </td></tr>
